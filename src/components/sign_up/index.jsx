...
export const Form = () => {
  ...
  const onSignUp = async (data) => {
    ...
    const response = await axios
      .post("http://localhost:3001/sign_up", formData)
    ...
    <Container maxW="2xl" centerContent>
      ...
      <form onSubmit={handleSubmit(onSignUp)}>
        <FormControl>
          ...
          />
          <br></br>
          <Text color="tomato">{errors?.email && errors?.email?.message}</Text>
          <br></br>
          ...
          />
          <br></br>
          <Text color="tomato">{errors?.age && errors?.age?.message}</Text>
          <br></br>
          ...
          <Center>
            <ButtonGroup>
              <Link to="/sign_in">
                <Button borderColor="#08BDA9" bg="#08BDA9" px={20} py={5}>
                  LOGIN
                </Button>
              </Link>
              <Button
